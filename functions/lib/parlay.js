...
function packFg(books, sportId, home, away) {
  ...
  return {
    ...
    softSpreadHomePrice: softSpreadPair?.home.price ?? null,
    softSpreadAwayPrice: softSpreadPair?.away.price ?? null,
    softOverPrice: softTotalPair?.over.price ?? null,
    softUnderPrice: softTotalPair?.under.price ?? null,
    spread,
...
function applyOdds(game, p) {
  ...
  const odds = {
    ...
    softSpreadHomePrice: p.softSpreadHomePrice ?? game.odds?.softSpreadHomePrice ?? null,
    softSpreadAwayPrice: p.softSpreadAwayPrice ?? game.odds?.softSpreadAwayPrice ?? null,
    softOverPrice: p.softOverPrice ?? game.odds?.softOverPrice ?? null,
    softUnderPrice: p.softUnderPrice ?? game.odds?.softUnderPrice ?? null,
...
export function mergeParlay(games, parlayEvents, sport) {
  ...
  for (const p of leftover) {
    ...
    pinUnderPrice: p.pinUnderPrice ?? null,
        ...
        heritageOverPrice: p.heritageOverPrice ?? null,
        heritageUnderPrice: p.heritageUnderPrice ?? null,
        softSpreadHomePrice: p.softSpreadHomePrice ?? null,
        softSpreadAwayPrice: p.softSpreadAwayPrice ?? null,
        softOverPrice: p.softOverPrice ?? null,
        softUnderPrice: p.softUnderPrice ?? null,
        softSource: p.softSource || null,
        spreadPrice: p.spreadPrice ?? null,
        totalPrice: p.totalPrice ?? null,
      },
      espnHomeWinPct: null,
