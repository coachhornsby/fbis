...
export const CFBD_FEATURE_CATALOG = [
  ...
  { canonical: "core_overall", group: "BASE POWER", endpoint: "/ratings/core", rawFields: ["overall", "throughWeek", "throughSeasonType", "offense", "defense"], unit: "CORE efficiency", orientation: "team", higherIsBetter: true, grain: "season", opponentAdjusted: true, availabilityTiming: "AVAILABLE with throughWeek — prefer week-bounded CORE over undated SP+ for in-season", leakageRisk: "medium", pregameSafe: "conditional", fallback: "SP+ prior-season", usedInChampion: false, candidateForChallenger: true, use: "prior", notes: "Live audit: AVAILABLE. Use throughWeek cutoff for temporal backtests when provided." },
