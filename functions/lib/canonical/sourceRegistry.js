...
export const SOURCE_REGISTRY = Object.freeze([
  ...
  },
  {
    ...
    cadence: "PAUSED",
    historicalCoverage: "shadow observations retained",
    commercialStatus: COMMERCIAL_STATUS.COMMERCIAL_USE_REVIEW_REQUIRED,
    priority: 10,
    fallbackPriority: null,
    active: false,
    notes: "ADMINISTRATIVELY PAUSED 2026-09-25. No scheduled or manual collector execution. Historical observations retained for audit only.",
    inPureModel: false,
    inMarketLayer: true,
  },
  {
  ...
  },
  {
    ...
    sports: ["nfl"],
    domain: "sports",
    dataFamilies: ["pbp", "epa", "rosters", "schedules"],
    endpointOrFeed: "github.com/nflverse",
    cadence: "daily + historical",
    historicalCoverage: "multi-season PBP",
    commercialStatus: COMMERCIAL_STATUS.RESEARCH_ONLY,
    priority: 2,
    fallbackPriority: null,
    active: true,
    notes: "Historical/PBP research. Dead injury dumps are not 2026 injury truth.",
    inPureModel: true,
    inMarketLayer: false,
  },
  {
    providerId: "heritage",
    name: "Heritage (execution context)",
    sports: ["mlb", "nfl", "nba", "cfb", "cbb", "nhl"],
    domain: "market",
    dataFamilies: ["execution_context", "confirmation"],
    endpointOrFeed: "operator Heritage board / confirmation",
    cadence: "manual execution",
    historicalCoverage: "executed-bet ledger",
    commercialStatus: COMMERCIAL_STATUS.PRIMARY_PRODUCTION,
    priority: 1,
    fallbackPriority: null,
    active: true,
    notes: "Execution context only. Never auto-authorize. Human confirmation required.",
    inPureModel: false,
    inMarketLayer: true,
  },
  {
    providerId: "nba_stats_licensed",
    name: "NBA licensed machine-readable feed",
    sports: ["nba"],
    domain: "sports",
    dataFamilies: ["schedule", "box", "lineups", "availability", "tracking"],
    endpointOrFeed: "UNOBTAINED — rights-cleared provider required",
    cadence: "slate + pregame",
    historicalCoverage: "provider-dependent",
    commercialStatus: COMMERCIAL_STATUS.BLOCKED,
    priority: 1,
    fallbackPriority: null,
    active: false,
    notes: "PROVIDER_OR_LICENSE_BLOCKED. NBA.com/Stats remains reference/reconciliation unless licensed.",
    inPureModel: true,
    inMarketLayer: false,
  },
  {
    providerId: "nhl_stats_licensed",
    name: "NHL licensed machine-readable feed",
    sports: ["nhl"],
    domain: "sports",
    dataFamilies: ["schedule", "pbp", "shifts", "goalies", "xg"],
    endpointOrFeed: "UNOBTAINED — commercial agreement required",
    cadence: "slate + pregame",
    historicalCoverage: "provider-dependent",
    commercialStatus: COMMERCIAL_STATUS.BLOCKED,
    priority: 1,
    fallbackPriority: null,
    active: false,
    notes: "PROVIDER_OR_LICENSE_BLOCKED. Do not scrape around licensing.",
    inPureModel: true,
    inMarketLayer: false,
  },
]);
