...
export const COLLEGE_MODELS = {
  ...
  "CFB-FBIS-v2": { id: "CFB-FBIS-v2", sport: "cfb", name: "Independent opponent-adjusted CFB projection (prior + rolling + matchup + QB + context)", version: "v2", role: "shadow", family: "matchup", canQualify: false, marketInformed: false, independent: true },
