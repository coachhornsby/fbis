...
export const COLLEGE_MODELS = {
  ...
  "CBB-KENPOM-RATINGS-v1": { id: "CBB-KENPOM-RATINGS-v1", sport: "cbb", name: "KenPom authorized API adjusted ratings", version: "v1", role: "shadow", family: "ratings", canQualify: false, marketInformed: false, independent: true, optional: true },
  ...
  "CBB-KENPOM-FANMATCH-BENCHMARK": { id: "CBB-KENPOM-FANMATCH-BENCHMARK", sport: "cbb", name: "KenPom FanMatch external benchmark — comparison only", version: "v1", role: "benchmark", family: "external-benchmark", canQualify: false, canAuthorizeWager: false, marketInformed: false, independent: false, optional: true, projectionEnabled: false, featureEligible: false, ensembleEligible: false },
