...
export const CFBD_ENDPOINT_PROBES = [
  ...
  { family: "advanced", endpoint: "/ppa/predicted", query: (y) => ({ year: y }) },
  ...
  { family: "advanced", endpoint: "/game/box/advanced", query: (y, w) => ({ year: y, week: w || AUDIT_KNOWN_WEEK.week }), requiresWeek: true },
  ...
  { family: "advanced", endpoint: "/ratings/srs/expanded", query: (y) => ({ year: y }), aliasOf: "/ratings/srs", note: "legacy alias used by production refresh" },
  { family: "advanced", endpoint: "/ratings/elo", query: (y) => ({ year: y }) },
  { family: "advanced", endpoint: "/ratings/core", query: (y) => ({ year: y }), note: "production alias; may 404 if not entitled" },
  ...
  { family: "plays", endpoint: "/live/plays", query: () => ({}), note: "live only when games in progress" },
  { family: "plays", endpoint: "/metrics/wp", query: (y, w) => ({ year: y, week: w || AUDIT_KNOWN_WEEK.week, team: "Ohio State" }), requiresWeek: true },
  ...
  { family: "plays", endpoint: "/play/types", query: () => ({}) },
  { family: "plays", endpoint: "/play/stat/types", query: () => ({}) },
